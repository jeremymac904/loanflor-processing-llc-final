 ...
 *  Flo downstream: the resolved text is rebranded here so plugin bundles and
 *  any future message source get the same treatment as the app catalog. */
function render(value: unknown, args: unknown[]): null | string {
  ...
  if (typeof value === 'function') {
    return rebrandText((value as (...args: unknown[]) => string)(...args))
  }
