<!-- FLO downstream context: keep this short and preserve upstream guidance below. -->
Read `.flo/docs/PROJECT_CONTEXT.md` before any task; follow its canonical documentation links.
Do not launch another coding agent, push, deploy, or access borrower data during bootstrap verification.
